          ...
          <div className="space-y-6">
            {contactOptions.map((contact, index) => (
              ...
              >
                ...
                >
                  <contact.icon className="text-white group-hover:scale-110 transition-all duration-300" />
                </Button>
                <div>
            ...
            <div className="h-[300px] w-full xs:w-[350px] aspect-square rounded-xl overflow-hidden">
              <iframe
