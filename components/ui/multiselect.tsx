  ...
  return (
    ...
    >
          ...
          {selected.map((option) => {
            return (
              ...
              >
                ...
                <button
                  className={cn(
                    "focus-visible:border-ring focus-visible:ring-ring/50 absolute -inset-y-px -end-px" +
                      " flex size-7 items-center justify-center rounded-e-md border border-transparent p-0" +
                      " outline-hidden transition-[color,box-shadow] outline-none focus-visible:ring-[3px]",
                    crossIconClassName,
                  )}
                  onKeyDown={(e) => {
                    if (e.key === "Enter") {
      ...
      <div className="relative">
        <div
          className={cn(
            "border-transparent absolute top-2 z-10 w-full overflow-hidden rounded-md border",
